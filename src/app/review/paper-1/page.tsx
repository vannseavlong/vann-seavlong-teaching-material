    ...
    <main className="min-h-screen pt-16">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        <section id="answers" className="scroll-mt-28">
          ...
          <ContextText>
            <strong>Setup for (d)–(f):</strong> On each successive swing, the ball travels 95% of its
            previous distance — a geometric sequence with <InlineMath math="u_1 = 17.1" /> and common
            ratio <InlineMath math="r = 0.95" />.
            <br />
